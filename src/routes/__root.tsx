  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-start px-4 py-28 sm:px-6">
      ...
      <div className="mt-8 flex gap-3">
        <Link
          to="/"
          className="rounded-none bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:bg-brand hover:text-brand-foreground"
        >
          Go to the homepage
        </Link>
        <Link
          to="/search"
          className="rounded-none border border-border px-4 py-2 text-sm font-medium hover:bg-surface"
        >
          Search articles
        </Link>
      </div>
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[60] focus:rounded-none focus:bg-primary focus:px-4 focus:py-2 focus:text-sm focus:text-primary-foreground"
      >
        Skip to content
      </a>
